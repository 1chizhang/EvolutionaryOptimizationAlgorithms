...
public class EntryWindow {
    ...
    private void createTable() {
        ...
        frame.setTitle("Course Scheduling System Based on Genetic Algorithm");
        frame.pack();
        ...
        panel = new JPanel();
        startBruteButton = new JButton("开始排课(GA)");
        ...
        startBruteButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                if(ga.getCoursesListSize()==0){
                    JOptionPane.showMessageDialog(null, "请先导入课程excel文件", "注意", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                myTable.clear();
        ...
        if (DEBUG) {
            Dir = "/Users/22179/Desktop/ga_ttp/1.xls";
            FileProcesser fileProcesser = new FileProcesser();
            fileProcesser.read(Dir);
            ga.setCoursesList(fileProcesser.getCourseList());
        }
